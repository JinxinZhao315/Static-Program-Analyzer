...
TEST_CASE("PQLSemanticCheck test 1") {
	...
	try {
		...
		cout << "syntax errors: it should be syntax correct" << endl;
	}
}
TEST_CASE("PQLSemanticCheck test 2") {
...
TEST_CASE("PQLSemanticCheck test 3") {
...
TEST_CASE("PQLSemanticCheck test 4") {
...
TEST_CASE("PQLSemanticCheck test 5") {
...
TEST_CASE("PQLSemanticCheck test 6") {
...
TEST_CASE("PQLSemanticCheck test 7") {

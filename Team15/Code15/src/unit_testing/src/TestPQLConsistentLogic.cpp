...
TEST_CASE("Test ModifiesS Cases") {
	SECTION("Test Positive Cases") {
		...
		REQUIRE(refConsistentLogic->hasRef("ModifiesS", "assign", "underscore") == true);
		...
		REQUIRE(refConsistentLogic->hasRef("ModifiesS", "if", "underscore") == true);
...
TEST_CASE("Test ModifiesP Cases") {
	SECTION("Test Positive Cases") {
		...
		REQUIRE(refConsistentLogic->hasRef("ModifiesP", "procedure", "underscore") == true);
		...
		REQUIRE(refConsistentLogic->hasRef("ModifiesP", "quotedIdent", "underscore") == true);
...
TEST_CASE("Test UsesP Cases") {
	SECTION("Test Positive Cases") {
		...
		REQUIRE(refConsistentLogic->hasRef("UsesP", "procedure", "underscore") == true);
		...
		REQUIRE(refConsistentLogic->hasRef("UsesP", "quotedIdent", "underscore") == true);
...
TEST_CASE("Test UsesS Cases") {
	SECTION("Test Positive Cases") {
		...
		REQUIRE(refConsistentLogic->hasRef("UsesS", "assign", "underscore") == true);
		REQUIRE(refConsistentLogic->hasRef("UsesS", "while", "quotedIdent") == true);
		REQUIRE(refConsistentLogic->hasRef("UsesS", "if", "underscore") == true);
	...
	SECTION("Test Negative Cases") {
		...
		REQUIRE(refConsistentLogic->hasRef("UsesS", "procedure", "underscore") == false);
		...
		REQUIRE(refConsistentLogic->hasRef("UsesS", "read", "underscore") == false);
